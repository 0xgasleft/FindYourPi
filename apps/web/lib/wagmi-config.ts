...
import { arcMainnet, hardhatLocal } from "./chains";
...
export const wagmiConfig = createConfig({
  chains: [arcMainnet, hardhatLocal],
  connectors: [injected()],
  ...
  transports: {
    ...
    [arcMainnet.id]: http(process.env.NEXT_PUBLIC_RPC_URL ?? arcMainnet.rpcUrls.default.http[0]),
  },
});
